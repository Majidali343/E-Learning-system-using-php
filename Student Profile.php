    ...
    <div class="container">
        ...
        <div class="content">
            ...
            ?>
                ...
                <h3>First Name</h3>
                <input class="Name" name="P_Name" type="text" placeholder="Enter Name" value="<?php echo($fetch['firstname']);echo($fetch['secondname']) ?>" >
                <h3>Bio</h3>
                <textarea id="#" name="P_Bio" rows="4" cols="50" placeholder="Enter Bio" value="
                <?php if(isset($_POST['P_Bio'])) echo $_POST['P_Bio']; echo($fetch['Bio']) ?> "><?php echo $fetch['Bio'] ?></textarea>
                <h3>Desigination</h3>
                <input class="Desigination" name="P_Desigination" type="text" placeholder="Enter Desigination" value="<?php if(isset($_POST['P_Desigination'])) echo $_POST['P_Desigination']; echo($fetch['Designation']) ?>">
                <h3>Education</h3>
                <input class="Education" name="P_Education" type="text" placeholder="Enter Education" value="<?php if(isset($_POST['P_Education'])) echo $_POST['P_Education']; echo($fetch['Education']) ?>">
                <br>
                <div class="Save"> 
