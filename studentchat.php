    ...
    <div class="container">
        ...
        <section class="chat__section">
              <div class="brand">
                ...
                <a id="backhome" href="./Student Dashboard.php">Home</a></h3>
         ...
         $sql= "  SELECT chats.Courseid ,chats.senderId,chats.message ,users.firstname FROM `chats`
          ...
          ?>
               ...
               <div>
                <textarea id="textarea" cols="30" rows="1" placeholder="Enter message"></textarea>
                <button id="btn" onclick="send(<?php echo $_GET['Queriesid'] ;?>)">SEND</button>
               </div> 
